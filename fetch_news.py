...
__LIVE_SECTION__
  <div class="sched-section">
    <p class="sched-section-title">&#128240; __TODAY__ 本日のニュース</p>
    __TODAY_NEWS__
  </div>
...
def generate_schedule_html(articles, events, updated_at):
    ...
    for name, badge, station, sched, url, color, status, dow in SCHEDULE_PROGRAMS:
        # Override with auto-fetched schedule if available
        sched = _prog_sched_cache.get(name, sched)
...
def main():
    ...
    _GOOGLE_IMG_HOSTS = ('lh3.googleusercontent.com', 'lh4.googleusercontent.com',
                         'lh5.googleusercontent.com', 'lh6.googleusercontent.com',
                         'news.google.com', 'google.com/s2/favicons')
    _fixed = 0
    for _a in existing:
        img = _a.get('image', '')
