...
def _goods_card_html(g, esc):
    ...
    return (
        f'<a class="goods-card" href="{url}" target="_blank" rel="noopener">{img_block}'
        ...
        f'<span class="goods-buy">詳細・購入 &rarr;</span>'
        f'</div></a>'
    )
...
def generate_chart_html(charts, updated_at):
    ...
    daily_charts  = [c for c in charts if c.get('period_type') == 'daily']
