...
# status: 'active' = 現在放送中・出演中  /  'upcoming' = 公開予定
SCHEDULE_PROGRAMS = [
    ('やってM!LK',
     'TV', 'TBS テレビ', '定期放送中',
     'https://www.tbs.co.jp/yatte_milk/', '#cc0000', 'active'),
    ('君の好きは無敵',
     'TV ドラマ', 'TBS テレビ 火曜22:00〜', '放送中',
     'https://www.tbs.co.jp/kiminosukihamuteki_tbs/', '#880033', 'active'),
    ('レコメン!',
     'ラジオ', '文化放送', '定期放送中',
     'https://www.joqr.co.jp/qr/program/reco/', '#1565c0', 'active'),
    ('イマドキッ ドゥフドゥフナイト',
     'ラジオ', 'MBSラジオ', '定期放送中',
     'https://www.mbs1179.com/imadoki/', '#7b1ea2', 'active'),
    ('トイ・ストーリー５',
     '映画', 'Disney / 2026年夏公開予定', '公開予定',
     'https://www.disney.co.jp/movie/toy5', '#0057a8', 'upcoming'),
    ('仮面ライダーゼッツ＆超宇宙刑事ギャバン',
     '映画', '2026年夏公開予定', '公開予定',
     'https://zeztz-gavan-26movie.com/', '#2c2c2c', 'upcoming'),
    ('M!LK 1st Mini Album',
     'リリース', '2026年09月16日発売', '予約受付中',
     'https://victor-store.jp/search/?keyword=M%21LK', '#d4006e', 'upcoming'),
]
...
KNOWN_GOODS = [
    {
        ...
        'price':    '¥2,530（税込）',
        'url':      'https://victor-store.jp/search/?keyword=M%21LK',
        'image':    '',
        'date':     '2026-09-16',
    },
    {
...
def fetch_goods():
    ...
    all_goods = KNOWN_GOODS + scraped_non_known
...
def generate_schedule_html(articles, updated_at):
    ...
    if upcoming_cards:
        prog_sections += (
            '<p class="sched-section-label" style="margin-top:28px">&#128197; 公開予定・近日発売</p>'
