...
_ARTICLE_BODY_SELECTORS = [
    ...
    '.newsDetailArticle',                            # Oricon News
    '.articleDetailLead',                            # Oricon News lead
    '.oricon-news-detail', '.oricon-article-body',   # Oricon 別パターン
    '[class*="newsDetail"]', '[class*="articleDetail"]',  # Oricon class 変更対応
    '.articleBody', '.article__body',                # 通用變體
    '.sanspo-article-body', '.sanspo-body',          # Sanspo
...
def fetch_oricon_charts():
    ...
    # ── Per-chart-code guard: build set of codes already fetched this week ────
    ex_for_guard = load_json(CHARTS_FILE)
    done_codes = {e['chart_code'] for e in ex_for_guard if e.get('date') == this_week_str}
    ...
    for chart_code, chart_name in _ORICON_CHART_TARGETS:
        if chart_code in done_codes:
            print(f'  [{chart_name}] already up to date for {this_week_str}, skipping')
            continue
        found_code = 0
...
:root {
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .tokuten-imgs img { height: 140px; width: auto; border-radius: 8px; object-fit: cover; border: 1px solid var(--border); }
  .store-chip {
      ...
      <div class="tokuten-row-head">
        ...
        <div class="tokuten-row-body">
          ...
          <div class="tokuten-imgs">
            <img src="https://sd-milk.com/s3/skiyaki/uploads/ckeditor/pictures/860853/content_260710_M_LK_mini_album_kokuchi_04_4.jpg" alt="早期セット予約特典 クリアトレカ" loading="lazy">
          </div>
    ...
    <div class="tokuten-row">
      <div class="tokuten-row-head">
        ...
        <div class="tokuten-row-body">
          ...
          <div class="tokuten-imgs">
            <img src="https://sd-milk.com/s3/skiyaki/uploads/ckeditor/pictures/860852/content_260710_M_LK_mini_album_kokuchi_04_3.jpg" alt="早期予約特典 ペアトレカ" loading="lazy">
          </div>
          <div class="tokuten-stores">
            <span class="store-chip">VICTOR ONLINE</span><span class="store-chip">楽天ブックス</span>
            <span class="store-chip">セブンネット</span><span class="store-chip">TOWER RECORDS ONLINE</span>
...
function compute() {
  ...
  const _tokRow = (t, bonus) => {
    const imgHtml = t.img ? `<img class="res-tok-img" src="${t.img}" alt="" loading="lazy" onerror="this.style.display='none'">` : '';
...
def main():
    ...
    # minor GitHub Actions cron delays.
