...
function openArticleModal(a){
  ...
  bz.textContent=a.summary_zh||'（翻譯準備中）';
  var bj=document.getElementById('am-body-ja');
  bj.textContent=a.summary_ja||'';
...
.am-img-item img{display:block;height:170px;width:auto;max-width:280px;object-fit:cover;}
...
.am-body-zh{font-size:.95rem;line-height:1.9;color:#111118;max-width:62ch;white-space:pre-wrap;}
...
def main():
    ...
    # 先抓內文（body），這樣 summary_ja 有內容後再翻譯才有效果
