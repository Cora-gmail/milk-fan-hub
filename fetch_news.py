...
function renderEvents(){
  ...
  c.innerHTML='';
  if(EVENTS.length===0){
    c.innerHTML='<div class="no-schedule"><p style="font-size:.9rem;color:#4a5568;">演出情報を自動取得できませんでした。</p><p style="margin-top:10px;font-size:.82rem;color:#718096;">公式サイトで最新スケジュールをご確認ください：</p><div style="margin-top:14px;display:flex;gap:10px;flex-wrap:wrap"><a href="https://sd-milk.com/calendar" target="_blank" rel="noopener" style="display:inline-block;padding:8px 18px;background:var(--blue);color:#fff;border-radius:20px;font-size:.82rem;text-decoration:none;">公式カレンダー &#8599;</a><a href="https://sd-milk.com/contents/schedule" target="_blank" rel="noopener" style="display:inline-block;padding:8px 18px;background:var(--blue2);color:#fff;border-radius:20px;font-size:.82rem;text-decoration:none;">スケジュール一覧 &#8599;</a></div></div>';
    return;
  }
  if(selected){
