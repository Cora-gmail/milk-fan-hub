...
.card-img{aspect-ratio:16/9;overflow:hidden;background:#eee;}.card-img img{width:100%;height:100%;object-fit:cover;display:block;}
...
function openArticleModal(a){
  ...
  imgs.forEach(function(src){
    ...
    item.innerHTML='<img src="'+esc(src)+'" alt="" loading="lazy" onerror="this.parentElement.remove()">';
...
.am-img-item{flex-shrink:0;border-radius:8px;overflow:hidden;border:1px solid #e8e8ee;}
.am-img-item{flex-shrink:0;width:240px;height:160px;overflow:hidden;border-radius:8px;border:1px solid #e8e8ee;background:#eee;}.am-img-item img{width:100%;height:100%;object-fit:cover;display:block;}
