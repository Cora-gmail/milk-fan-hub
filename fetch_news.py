...
.card-img{position:relative;overflow:hidden;background:var(--bg);display:flex;align-items:center;justify-content:center;min-height:80px;}
.card-img img{width:100%;height:auto;display:block;max-height:220px;object-fit:contain;}
...
SOURCE_URLS = {
    ...
    'Oricon':             'https://www.oricon.co.jp/search/?q=m%21lk&cat=news',
    'BARKS':              'https://www.barks.jp/search/?q=m%21lk&type=news',
    'SANSPO':             'https://www.sanspo.com/search/?q=m%21lk',
    'Billboard Japan':    'https://www.billboard-japan.com/d_news/?q=m%21lk',
    'Musicvoice':         'https://www.musicvoice.jp/?s=m%21lk',
    'SPICE':              'https://spice.eplus.jp/?s=M%21LK',
    'Musicman':           'https://www.musicman.co.jp/search/?q=m%21lk',
    'The First Times':    'https://www.thefirsttimes.jp/?s=M%21LK',
    'Modelpress':         'https://mdpr.jp/search?q=m%21lk',
    '美的.com':           'https://www.biteki.com/?s=m%21lk',
    "MEN'S NON-NO":       'https://www.mensnonno.jp/?s=m%21lk',
    'VOGUE JAPAN':        'https://www.vogue.co.jp/search?q=m%21lk',
    'TVガイドWeb':        'https://www.tvguide.or.jp/cmn_keyword/mlk/',
    'WEBザテレビジョン':  'https://thetv.jp/news/search/?q=m%21lk',
    'ebidan.jp':          'https://ebidan.jp/search/?q=m%21lk',
