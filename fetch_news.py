...
_PHOTO_URL_PATTERNS = [
    r'mdpr\.jp/photo/detail/',                     # Modelpress
...
def fetch_oricon_charts():
    ...
    # Tracks every (chart_code, date) pair we've already processed, whether or
    # not M!LK entries were found, so we never redundantly re-scan.
    ...
    # Also treat existing real chart entries as "scanned"
